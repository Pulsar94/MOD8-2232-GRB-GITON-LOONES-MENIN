...
const passwordShown = ref("·".repeat(initialPassword.value.length));
</script>
...
<template>
  <body>
    ...
    <div class="informations" v-else>
      <p>Name : <input type="text" v-model="editedName" required /></p>
      <p>Age : <input type="number" v-model="editedAge" required /></p>
      <p>Email : <input type="email" v-model="editedEmail" required /></p>
      <p>
        Phone :
        <input type="number" v-model="editedPhone" required />
      </p>
      <p>
        Password : <input type="password" v-model="editedPassword" required />
      </p>
      <div class="buttons">
