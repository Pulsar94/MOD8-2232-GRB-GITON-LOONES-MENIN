<template>
  <div class="home-container">
    ...
    <p>Struggling to keep track of your spending? Overwhelmed by numerous bills, receipts, and expenses? Say hello to Budget Vision—your trusted partner in financial management.</p>
    <p>Our platform offers you a comprehensive view of all your expenditures, breaking them down into easy-to-understand categories and visual diagrams. We simplify budgeting so that you can focus on making better financial decisions.</p>
    <p>Unlock the power of smart spending. With Budget Vision, you gain insight, clarity, and control over your financial world. Don't just view your expenses—understand them.</p>
    ...
    <div class="container">
      ...
      <div class="table-chart">
        <TableChart :chartWidth="'750px'" :chartHeight="'500px'" :chartMargin="'none'" :transactions="myTransactionsArray"/>
...
export default {
  components: {TotalAndAverageExpenses, TableChart, LineChart, PieChart, RecentTransactions, ComboChart, NavBar},
