<template>
  <body>
    <p>
      At BudgetVision, accessible from https://budgetvision.com, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document
      contains types of information that is collected and recorded by
      BudgetVision and how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in BudgetVision. This policy is not applicable to any
    ...
    <p>
      BudgetVision follows a standard procedure of using log files. These files
    ...
    <p>
      ...
      advertising partners of BudgetVision.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on BudgetVision, which are sent
    ...
    <p>
      Note that BudgetVision has no access to or control over these cookies that
    ...
    <p>
      BudgetVision's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      BudgetVision does not knowingly collect any Personal Identifiable
