<template>
  <body>
    ...
    <p>
      ...
      of Budget Vision's Website, located at https://budgetvision.com.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use BudgetVision if you do not agree to take all of the
    ...
    <p>
      We employ the use of cookies. By accessing BudgetVision, you agreed to use
      cookies in agreement with the Budget Vision's Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, Budget Vision and/or its licensors own the
      intellectual property rights for all material on BudgetVision. All
      intellectual property rights are reserved. You may access this from
      BudgetVision for your own personal use subjected to restrictions set in
    ...
    <p>
      ...
      opinions and information in certain areas of the website. Budget Vision
      does not filter, edit, publish or review Comments prior to their presence
      on the website. Comments do not reflect the views and opinions of Budget
      Vision,its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent
      permitted by applicable laws, Budget Vision shall not be liable for the
    ...
    <p>
      Budget Vision reserves the right to monitor all Comments and to remove any
    ...
    <p>
      You hereby grant Budget Vision a non-exclusive license to use, reproduce,
    ...
    <p>
      ...
      hyperlink compensates the absence of Budget Vision; and (d) the link is in
    ...
    <p>
      ...
      e-mail to Budget Vision. Please include your name, your organization name,
    ...
    <p>
      No use of Budget Vision's logo or other artwork will be allowed for
